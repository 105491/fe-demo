...
interface aInterface {id:number;uname:string}

type aType =aInterface[];
var a:aType = [{ id: 1, uname: '123' }, { id: 2, uname: '1234' }, { id: 3, uname: '1234' }]


export function uniquePush<U extends {}>(sourceItem:U, targetArray:U[], ident:keyof U):void{
